...
- Collaudo prolungato implementato: [M0-STABILITY](DOCS/it/M0-STABILITY.md), timer nel normale event loop Qt, dodici passi per ciclo, preferenze/appunti isolati, log Go/cache e raccoglitore RSS esterno con deadline. Smoke test locale 10 s, unit test, vet e self-test superati; CI `8fd55b9` run 35879464771 completata con sei job verdi. Sessione Cocoa di 30 minuti in corso dal 2026-09-23 15:11:46 UTC, copia isolata `/tmp/webfence-stability-8fd55b9/WebFence Stability.app`, output `/tmp/webfence-soak-macos-8fd55b9-30m/`. Processo figlio 75460, raccoglitore 75446, sessione exec 72917: verificarli prima di attendere o dichiarare conclusione; non riavviare sulla sola assenza di output. Primi 105 cicli/315 s superati, nessun esito finale ancora.

- Inventario macOS automatico aggiunto alla preparazione del bundle: nome/UUID/ARM64 verso keg Homebrew, materiali installati, Go e patch/licenze Cocoa, docs IT/EN. Prova 28 Mach-O/15 pacchetti e rifiuto file sconosciuto verificati. Hash esplicitamente prima della firma; `distribution_ready=false`, Qt/GLib e sorgenti corrispondenti ancora incompleti. Bundle locale firmato verificato, inclusi collegamenti docs e metadati con dirty=true. Ricetta GLib richiama patch Homebrew non installata; sorgenti/patch restano da acquisire. CI della modifica da verificare; dettagli in M0-PACKAGING.
...
- Prolonged trial implemented: [M0-STABILITY](DOCS/en/M0-STABILITY.md), timer in normal Qt event loop, twelve steps per cycle, isolated preferences/clipboard, Go/cache logs and external RSS collector with deadline. Local 10 s smoke, unit tests, vet and self-test passed; CI `8fd55b9` run 35879464771 completed with six passing jobs. 30-minute Cocoa session running since 2026-09-23 15:11:46 UTC, isolated copy `/tmp/webfence-stability-8fd55b9/WebFence Stability.app`, output `/tmp/webfence-soak-macos-8fd55b9-30m/`. Child PID 75460, collector 75446, exec session 72917: verify before waiting or declaring completion; do not restart solely for missing output. First 105 cycles/315 s passed, no final outcome yet.

- Automated macOS inventory added to bundle preparation: name/UUID/ARM64 matched to Homebrew kegs, installed materials, Go and Cocoa patch/licenses, IT/EN docs. Probe of 28 Mach-O/15 packages and unknown-file rejection verified. Hashes explicitly before signing; `distribution_ready=false`, Qt/GLib and corresponding sources still incomplete. Local signed bundle verified, including doc links and metadata with dirty=true. GLib recipe references an uninstalled Homebrew patch; sources/patches remain to acquire. Change CI to verify; details in M0-PACKAGING.
