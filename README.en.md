...
Dependency materials: [source and notice collector](DOCS/en/M0-SOURCE-MATERIALS.md) verified against 15 upstream archives; optional attachment of 247 notices before macOS bundle signing. Each new macOS bundle also declares the [minimum OS derived from its own binaries](DOCS/en/M0-PACKAGING.md#artifact-declared-minimum-system-version). Distribution review remains open.
