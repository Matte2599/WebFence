...
The [M1 project store](DOCS/en/M1-PROJECT-STORE.md) keeps metadata in SQLite, migrates v1/v2 schemas to v3 and records versioned authorization renewals and revocations; the GUI does not use it yet.
