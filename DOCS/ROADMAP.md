...
- [x] Navigazione Qt: menu Visualizza, etichette filtri, scorciatoie di focus e cambio lingua senza reset; self-test con interfaccia accessibile Qt. La verifica con lettori reali resta aperta.
...
- [x] Qt navigation: View menu, filter labels, focus shortcuts and language change without reset; self-test covers the Qt accessible interface. Actual screen-reader verification remains open.
