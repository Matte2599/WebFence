...
- [ ] Build e packaging di prova sui sistemi candidati; matrice OS/architetture reale. [Ricognizione](it/M0-PACKAGING.md): il bundle locale richiede macOS 26; minimo desiderato da fissare e verificare. [Pacchetti Debian/Windows](it/ADR-007-PACKAGING.md) e runtime separati implementati; Debian amd64/arm64 superati in CI, raccolta notices Windows corretta dopo errore ICU e in riverifica.
