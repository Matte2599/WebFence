...
[CI `0a568ff`, sette job verdi](https://github.com/Matte2599/WebFence/actions/runs/35967360307): [rivalidazione privata dell'identità Cocoa](evidence/macos-ax-table-reset-2026-09-24.md). La variante con indici riga/colonna distinti compila e passa firma, self-test e soak sul runner macOS 26, ma fallisce gli stessi **sei stadi AX su nove** del bundle normale, con righe/celle `-25202`. Ipotesi scartata; prova extra rimossa dalla CI ordinaria, nessuna patch di produzione adottata. M0-01 resta aperto. Una prova locale separata di aggiornamento differito delle righe è inconclusiva e non adottata.
...
[CI `0a568ff`, seven green jobs](https://github.com/Matte2599/WebFence/actions/runs/35967360307): [private Cocoa identity recheck](evidence/macos-ax-table-reset-2026-09-24.md). The distinct row/column index variant builds and passes signing, self-test and soak on the macOS 26 runner, but fails the same **six of nine AX stages** as the normal bundle, with `-25202` rows/cells. Hypothesis rejected; extra trial removed from routine CI, no production patch adopted. M0-01 remains open. A separate local trial of deferred row updates is inconclusive and not adopted.
