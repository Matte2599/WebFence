...
Le prove sintetiche coprono export bilingue, escaping HTML, revisione storica, bundle non firmato, manomissioni di artefatto/manifest/JWS, file extra, chiave errata/non fidata/revocata, rotazione e portachiavi indisponibile. Non sono stati esportati report di clienti o contattati target esterni. Il [desktop M2](M2-GUI-EXTENSION.md) espone export/verifica dalla run selezionata e le funzioni di rotazione, revoca, export/import pubblico; l'alpha CLI non è un pacchetto di distribuzione supportato.
