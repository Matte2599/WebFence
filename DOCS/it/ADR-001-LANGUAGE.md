...
Prima implementazione: versione Go supportata al momento di M0, fissata nel futuro `go.mod` e in CI. Nessuna versione minima o dipendenza è dichiarata installata oggi.
