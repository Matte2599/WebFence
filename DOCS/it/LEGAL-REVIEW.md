...
- [Otto firme distaccate dei sorgenti Windows](../evidence/windows-signatures-2026-09-24.md): verifica OpenPGP offline con sette chiavi fissate per fingerprint; identità dei firmatari, fiducia nelle chiavi, firme dei binari e obblighi di distribuzione restano aperti.
