...
- [Verifica Git offline di winpthreads](../evidence/windows-vcs-2026-09-24.md): checksum della ricetta riprodotto con pack bloccato, senza checkout o ricetta eseguita; le otto firme `SKIP` e l'autenticità esterna restano aperte.
