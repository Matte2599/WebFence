...
- [Verifica Git offline di winpthreads](../evidence/windows-vcs-2026-09-24.md): checksum della ricetta riprodotto con pack bloccato, senza checkout o ricetta eseguita.
- [Otto firme distaccate dei sorgenti Windows](../evidence/windows-signatures-2026-09-24.md): verifica OpenPGP offline con sette chiavi fissate per fingerprint; identità dei firmatari, fiducia nelle chiavi e obblighi di distribuzione restano aperti.
- [Ventidue firme dei pacchetti binari Windows](../evidence/windows-binary-signatures-2026-09-24.md): chiave pubblica estratta da una versione SHA-256 vincolata della keyring MSYS2; verificare l'identità/fiducia indipendente e gli obblighi relativi alla redistribuzione della chiave e dei metadati dal pacchetto GPL-3.0-or-later.
- [Import Qt Windows e opzioni di libreria di sistema](../evidence/windows-qt-system-imports-2026-09-24.md): la ricetta collegata a `.BUILDINFO` e gli import PE indicano dipendenze dinamiche nei componenti esaminati del pacchetto; da soli non stabiliscono l'inclusione dei plugin nello ZIP o escludono codice incorporato.
- [Inventario PE dello ZIP Windows](../evidence/windows-pe-import-inventory-2026-09-24.md): 15 file Qt identificati nello ZIP verificato, compreso `qjpeg.dll` ma non `qsqlite.dll`; import statici registrati per 44 file PE. Resta da esaminare codice incorporato, caricamento dinamico e obblighi per i componenti realmente distribuiti.
- [Corrispondenza dei notices Windows](../evidence/windows-notice-linkage-2026-09-24.md): 74 file nella prima CI; [selezione ampliata a 136 sidecar](../evidence/windows-attribution-sidecars-2026-09-24.md) e controllo dei 27 riferimenti Qt. La presenza dei testi non accerta completezza degli avvisi o obblighi legali.
