...
- [Import Qt Windows e opzioni di libreria di sistema](../evidence/windows-qt-system-imports-2026-09-24.md): la ricetta collegata a `.BUILDINFO` e gli import PE indicano dipendenze dinamiche nei componenti esaminati del pacchetto, senza stabilire l'inclusione dei plugin nello ZIP o escludere codice incorporato.
