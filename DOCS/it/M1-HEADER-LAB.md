...
I blocchi successivi hanno aggiunto [discovery HTML limitata](M1-DISCOVERY-LAB.md) e [visite HTTP controllate](M1-CONTROLLED-CRAWL.md) in un percorso core separato; `RunHeaderLab` continua a visitare solo seed loopback. Persistenza, quota/recupero, risultati UI IT/EN e copertura incompleta sono nello [stato M1 corrente](M1-VALIDATION.md). Il [piano storico dei collaudi umani](M1-PREREQUISITES.md) resta da eseguire per le relative dichiarazioni.
