...
Restano per M1: discovery di link/form osservati senza invio automatico, policy di metodi/percorsi/esclusioni, rate limit, broker di produzione, dati di run persistenti e quota/recupero, risultati UI IT/EN e copertura incompleta visibile. Il [piano dei prerequisiti umani](M1-PREREQUISITES.md) resta aperto.
