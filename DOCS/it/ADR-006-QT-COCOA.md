...
Una nuova build locale macOS 26.6.2 è stata firmata e verificata; self-test Cocoa e client AX di 30 cicli passano, inclusi focus e attivazione della prima cella. Una variante privata identica ha superato altri 30 cicli (92 stadi AX); 93 campioni RSS non mostrano crescita sostenuta in quella breve prova. Non è un collaudo prolungato né un test VoiceOver. La CI macOS 15/26 con la patch consolidata resta da verificare; il test AX ora blocca il job se fallisce o se manca il permesso. [Registro bilingue](../evidence/macos-ax-table-reset-2026-09-24.md). M0-01 resta parziale.
