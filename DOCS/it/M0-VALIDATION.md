...
| M0-04 | Versioni, scheletro, cataloghi, CI | Completato sul codice `98478f2`: [CI sei job verdi](https://github.com/Matte2599/WebFence/actions/runs/35918855381), inclusi pacchetti Debian e Windows con runtime separato. | Ripetere sul commit conclusivo di M0 e verificare il remoto. |
