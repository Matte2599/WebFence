...
| M0-04 | Versioni, scheletro, cataloghi, CI | Completato sul codice `f99b3e7`: [CI sei job verdi](https://github.com/Matte2599/WebFence/actions/runs/35900777988), inclusi pacchetti Debian e Windows con runtime separato. | Ripetere sul commit conclusivo di M0 e verificare il remoto. |
