...
| M0-04 | Versioni, scheletro, cataloghi, CI | Completato sul codice `39c48ef`: [CI sei job verdi](https://github.com/Matte2599/WebFence/actions/runs/35888497914), inclusi pacchetti Debian e Windows con runtime separato. | Ripetere sul commit conclusivo di M0 e verificare il remoto. |
