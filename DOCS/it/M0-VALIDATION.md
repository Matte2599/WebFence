...
| M0-03 | GUI, SQLite, JWS, portachiavi | Parziale: [Qt scelto](ADR-002-GUI.md), [SQLite/JWS selezionati e provati](ADR-004-STORAGE-SIGNATURE.md). | Scelta portachiavi e prove reali dei backend, incluso servizio assente/bloccato senza fallback in chiaro. |
