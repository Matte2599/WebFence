...
| M0-04 | Versioni, scheletro, cataloghi, CI | Completato sul codice `953ed2d`: [CI quattro target verde](https://github.com/Matte2599/WebFence/actions/runs/35873709410), inclusi layout compatto e bundle Cocoa corretto. | Ripetere sul commit conclusivo di M0 e verificare il remoto. |
