...
| M0-04 | Versioni, scheletro, cataloghi, CI | Completato sul codice `3f68e6a`: [CI sei job verdi](https://github.com/Matte2599/WebFence/actions/runs/35916839178), inclusi pacchetti Debian e Windows con runtime separato. | Ripetere sul commit conclusivo di M0 e verificare il remoto. |
...
Riferimenti di licenza Qt recuperati: [11 testi aggiuntivi, 258 avvisi complessivi](M0-SOURCE-MATERIALS.md#riferimenti-di-licenza-qt-completati-nel-raccoglitore). Bundle locale ricostruito da `3598b5f` con modifiche dichiarate: 258 avvisi ricontrollati, legame con l’inventario corrente, supplementi Homebrew presenti, firma ad hoc e self-test Cocoa superati; preferenza lingua preservata. 41 test Python locali superati; CI nuovo codice da verificare.
