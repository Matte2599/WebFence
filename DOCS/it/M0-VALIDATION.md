...
| M0-04 | Versioni, scheletro, cataloghi, CI | Completato sul codice `3593dcc`: [CI sei job verdi](https://github.com/Matte2599/WebFence/actions/runs/35914285406), inclusi pacchetti Debian e Windows con runtime separato. | Ripetere sul commit conclusivo di M0 e verificare il remoto. |
