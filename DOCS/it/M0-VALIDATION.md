...
| M0-04 | Versioni, scheletro, cataloghi, CI | Completato sul codice `054bb2d`: [CI sei job verdi](https://github.com/Matte2599/WebFence/actions/runs/35904059667), inclusi pacchetti Debian e Windows con runtime separato. | Ripetere sul commit conclusivo di M0 e verificare il remoto. |
