...
| M0-04 | Versioni, scheletro, cataloghi, CI | Completato sul codice `8d3053f`: [CI sei job verdi](https://github.com/Matte2599/WebFence/actions/runs/35885936443), inclusi pacchetti Debian e Windows con runtime separato. | Ripetere sul commit conclusivo di M0 e verificare il remoto. |
...
Conferma dal log Cocoa macOS 15: viewport 60 punti per due righe da 60, minimo tabella 98; anche regressione intestazione, Tab/Shift+Tab e quattro cicli di stabilità Cocoa superati. La nuova [sessione da 30 minuti](M0-STABILITY.md) sullo stesso codice è in corso; non chiude ancora il gate assistivo.
