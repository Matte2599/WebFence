...
| M0-04 | Versioni, scheletro, cataloghi, CI | Completato sul codice `56840c5`: [CI sei job verdi](https://github.com/Matte2599/WebFence/actions/runs/35898848286), inclusi pacchetti Debian e Windows con runtime separato. | Ripetere sul commit conclusivo di M0 e verificare il remoto. |
