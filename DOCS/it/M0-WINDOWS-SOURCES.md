...
Il [registro di prova](../evidence/windows-signatures-2026-09-24.md) documenta sette chiavi pubbliche vincolate per gli otto input `SKIP`, compresi i firmatari con sottochiave GCC e PCRE2. Il collector richiede GnuPG nel PATH, verifica i fingerprint dichiarati dalla ricetta e firma/payload senza rete o esecuzione del sorgente. Raccolta locale completa: **21 archivi, 112 input verificati, zero non verificati nel piano attuale**; allegato rigenerato con lock e chiavi, vecchia raccolta rifiutata. **73 test Python locali** e prove complete di raccolta/allegato passati; CI del codice modificato in attesa. La validità crittografica non identifica autonomamente i firmatari né approva licenze o distribuzione.
