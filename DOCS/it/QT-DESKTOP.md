...
**Prova GUI macOS:** bundle aggiornato aperto; Cmd+O/F → filtro DEMO-10000 → F6 seleziona la riga; Tab raggiunge il riepilogo; Cmd+Shift+E apre le evidenze; Cmd+A seguito da Cmd+2 conserva il testo selezionato; Cmd+Shift+D nasconde il pannello e riporta il focus al controllo avanzato. Anche Visualizza → Leggi evidenze è stato attivato dal menu. Lingua riportata in italiano. Nella configurazione nativa osservata Tab dalle evidenze passa alla ricerca, saltando il pulsante copia: il ciclo effettivo dipende anche dalle convenzioni/impostazioni di navigazione macOS, non solo dall’ordine Qt. Non sono state modificate preferenze di accessibilità del sistema. Il nodo tabella è risultato intermittente anche in questa prova: assente subito dopo il filtro, nuovamente esposto dopo Tab. Nessuna certificazione VoiceOver.

**CI del task superata:** [run 35857456908](https://github.com/Matte2599/WebFence/actions/runs/35857456908), codice `6268ae3`: quattro job completati con build, vet, test Go e self-test Qt aggiornato; bundle macOS incluso. I test Tab/Shift+Tab e conservazione della selezione passano su tutti i runner. Su Linux Qt 6.4.2 i log dichiarano il reset esplicito della cache assistiva; non è una prova Orca.
...
Restano installer Windows per utenti finali, firme e notarizzazione, esecuzione su Windows 10/11 e Ubuntu 24.04 desktop reali, macchina macOS senza toolchain e prove sulle [versioni minime target](M1-SUPPORT-POLICY.md), ora decise. Anche la manutenzione Windows 10 dopo Qt 6.12 resta aperta. Licenza WebFence invariata; inventario e adempimenti Qt/MIQT da completare prima della distribuzione. Nessun acquisto o licenza commerciale sottoscritta.
