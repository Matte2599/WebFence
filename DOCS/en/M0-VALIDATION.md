...
| M0-03 | GUI, SQLite, JWS, keychain | Partial: [Qt selected](ADR-002-GUI.md), [SQLite/JWS selected and tested](ADR-004-STORAGE-SIGNATURE.md). | Keychain selection and actual backend tests, including absent/locked service without plaintext fallback. |
