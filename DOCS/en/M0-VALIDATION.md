...
| M0-04 | Versions, skeleton, catalogs, CI | Complete on code `3593dcc`: [six passing CI jobs](https://github.com/Matte2599/WebFence/actions/runs/35914285406), including Debian and Windows packages with separate runtimes. | Repeat on the final M0 code commit and verify the remote. |
