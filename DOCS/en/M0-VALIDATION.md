...
| M0-04 | Versions, skeleton, catalogs, CI | Complete on code `953ed2d`: [four-target CI passed](https://github.com/Matte2599/WebFence/actions/runs/35873709410), including compact layout and corrected Cocoa bundle. | Repeat on the final M0 commit and verify the remote. |
