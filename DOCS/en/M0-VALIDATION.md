...
| M0-04 | Versions, skeleton, catalogs, CI | Complete on code `56840c5`: [six passing CI jobs](https://github.com/Matte2599/WebFence/actions/runs/35898848286), including Debian and Windows packages with separate runtimes. | Repeat on the final M0 code commit and verify the remote. |
