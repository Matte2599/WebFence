...
- [Windows Qt imports and system-library options](../evidence/windows-qt-system-imports-2026-09-24.md): the recipe linked to `.BUILDINFO` and PE imports indicate dynamic dependencies in examined package components, without establishing which plugins are shipped in the ZIP or ruling out embedded code.
