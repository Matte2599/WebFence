...
- [Offline winpthreads Git verification](../evidence/windows-vcs-2026-09-24.md): recipe checksum reproduced from a locked pack without checkout or recipe execution; eight `SKIP` signatures and external authenticity remain open.
