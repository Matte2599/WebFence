...
La [selezione dei sidecar Windows](DOCS/evidence/windows-attribution-sidecars-2026-09-24.md) include ora 136 file di avviso e attribuzione collegati agli archivi binari, con controllo delle omissioni durante il packaging. La CI della modifica è in attesa; completezza delle licenze e revisione legale restano aperte.
