...
Le [otto firme distaccate dei sorgenti Windows](DOCS/evidence/windows-signatures-2026-09-24.md) passano ora la verifica OpenPGP offline locale con chiavi pubbliche vincolate; [CI `2cd9022`, sei job verdi](https://github.com/Matte2599/WebFence/actions/runs/35945996095). Identità dei firmatari, firme dei binari e revisione legale restano aperte.
