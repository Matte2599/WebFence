...
Le [otto firme distaccate dei sorgenti Windows](DOCS/evidence/windows-signatures-2026-09-24.md) passano ora la verifica OpenPGP offline locale con chiavi pubbliche vincolate; CI del codice modificato in attesa. Identità dei firmatari, firme dei binari e revisione legale restano aperte.
